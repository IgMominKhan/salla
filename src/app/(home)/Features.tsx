    ...
    <>
      <section className="text-clr-dark-gray-400">
        <div className="md:flex justify-evenly border-[1px] divide-y-[1px] md:divide-y-0 md:divide-x-reverse md:divide-x-[1px] rounded-sm md:rounded-[4px]">
          <div className="flex gap-5 p-3xl">
      ...
      <section>
        <div className="flex flex-col md:flex-row  gap-5">
          <div className="flex-1 flex justify-end items-center bg-right-top min-h-[170px] md:min-h-[250px] align-center bg-[url('../assets/images/feature/bannar1.png')] bg-cover">
          ...
          <div className="flex-1 flex justify-end items-center bg-right-top md:bg-center min-h-[170px] md:min-h-[250px] bg-[url('../assets/images/feature/bannar2.png')] bg-cover">
            <div className="p-6 md:py-14">
              <p>
                سماعات ديجتال
              </p>
